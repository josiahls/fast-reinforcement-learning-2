...
__all__ = ['isnone', 'map_dict_ex', 'D', 'BDTypeError', 'BDBatchSizeError', 'BDKeyMisMatchError', 'list2tensor', 'BD']
...
class BD(D):
    def __init__(self,*args,bd_batch_size=1,**kwargs):
        ...
        self.bd_batch_size=bd_batch_size
        super().__init__(*args,**kwargs)
    ...
    def __getitem__(self,o):
        if isinstance(o,int) or (is_listy(o) and isinstance(o[0],int)):
            return BD({k:self[k][o] for k in self})
