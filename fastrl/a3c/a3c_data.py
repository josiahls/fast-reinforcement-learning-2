...
__all__ = ['LinearA2C', 'r_estimate', 'unbatch', 'loss_func', 'A3CLearner', 'A3CTrainer', 'AvgEpisodeRewardMetric']
...
class AvgEpisodeRewardMetric(Metric):
    ...
    def accumulate(self,learn):
        ...
        print([y for y in yb if y.d])
        for r in rewards:self.rolling_rewards.append(r)
#         print(len(rewards))
